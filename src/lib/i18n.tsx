...
export const dict: Record<Lang, any> = {
  en: {
    ...
    auth: {
      ...
      resent: "Email sent again — check your inbox and spam folder.",
      errorUnconfirmed: "Your email isn't confirmed yet. Check your inbox or resend the link.",
      errorExists: "An account with this email already exists.",
      errorExistsCta: "Log in instead",
    ...
    gamify: {
      ...
      badges: {
        ...
        ex25: "25 Exercises",
        ex100: "100 Exercises",
        streak2: "2-Week Streak",
        streak4: "4-Week Streak",
        complete: "Program Completed",
      },
      storeTitle: "Get More Programs",
      storeSub: "One-time purchase · lifetime access.",
    },
    health: {
      title: "Health & Results",
      sub: "Your baseline, weekly check-ins and progress — visible only to you and your coach.",
      link: "Health & Results",
      promptTitle: "Set up your health profile",
      promptDesc: "Tell us your starting point so you can track real results.",
      promptCta: "Start now",
      ...
      goal: "Your goal",
      goalOptions: ["Lose weight", "Build muscle", "Fix posture / reduce pain", "General fitness"],
      activity: "Activity level",
      activityOptions: ["Mostly sitting", "Lightly active", "Active", "Very active"],
      injuries: "Injuries or surgeries (optional)",
      medications: "Medications (optional)",
      parqTitle: "Health screening",
      parqSub: "Answer honestly — this keeps your training safe.",
      parq: [
        ...
        "Do you ever feel dizzy or lose consciousness?",
        "Do you have a bone or joint problem that exercise could worsen?",
        "Are you taking blood pressure or heart medication?",
        "Is there any other reason you should not do physical activity?",
      ],
      yes: "Yes",
      no: "No",
      parqWarning:
        "You answered yes to a screening question — please consult a doctor before starting intense training. Graciano will take this into account.",
      consent:
        "I explicitly consent to storing my health data (weight, injuries, screening answers, photos) so my coach can guide my training. I can delete it anytime.",
      save: "Save profile",
      saved: "Profile saved.",
      checkinTitle: "Weekly Check-in",
      checkinSub: "Once a week: weigh in, rate your week, add photos if you want.",
      weight: "Weight (kg)",
      energy: "Energy",
      sleep: "Sleep quality",
      adherence: "Training adherence",
      soreness: "Recovery (how fresh do you feel?)",
      note: "Anything to tell your coach? (optional)",
      photos: "Progress photos (optional)",
      photoFront: "Front",
      photoSide: "Side",
      photoBack: "Back",
      submit: "Save check-in",
      submitted: "Check-in saved. See you next week!",
      historyTitle: "Your Journey",
      chartTitle: "Weight trend",
      compareTitle: "Before / Now",
      compareFirst: "Start",
      compareLast: "Latest",
      noCheckins: "No check-ins yet — your first one starts your journey.",
      delete: "Delete",
      date: "Date",
      kg: "kg",
      alreadyThisWeek: "You already checked in this week — come back next week.",
      error: "Something went wrong. Please try again.",
    },
    admin: {
      title: "Admin Panel",
      sub: "Manage clients, program access and inquiries.",
      tabClients: "Clients",
      tabHealth: "Check-ins",
      noHealth: "This client hasn't filled their health profile yet.",
      flag: "Medical flag — review before intense training",
      view: "View",
      tabAccess: "Access",
      tabApps: "Applications",
      tabLeads: "Newsletter",
      grantTitle: "Grant program access",
      ...
      emptyAccess: "No access granted yet.",
      emptyApps: "No applications yet.",
      emptyLeads: "No subscribers yet.",
  ...
  sq: {
    ...
    auth: {
      ...
      resend: "Nuk të erdhi? Ridërgo emailin",
      resendIn: "Ridërgimi i mundshëm pas",
      resent: "Emaili u dërgua sërish — kontrollo inbox-in dhe spam-in.",
      errorUnconfirmed: "Emaili yt s'është konfirmuar ende. Kontrollo inbox-in ose ridërgo linkun.",
      errorExists: "Ekziston tashmë një llogari me këtë email.",
      errorExistsCta: "Hyr në llogari",
    ...
    gamify: {
      streak: "Javë Rresht",
      streakUnit: "javë pa ndërprerje",
      exercises: "Ushtrime të Kryera",
      achievements: "Arritjet",
      badges: {
        first: "Stërvitja e Parë",
        ex25: "25 Ushtrime",
        ex100: "100 Ushtrime",
        streak2: "2 Javë Rresht",
        streak4: "4 Javë Rresht",
        complete: "Program i Përfunduar",
      },
      storeTitle: "Merr Programe të Tjera",
      storeSub: "Blerje një herë · akses i përhershëm.",
    },
    health: {
      title: "Shëndeti & Rezultatet",
      sub: "Pika jote e nisjes, check-in-et javore dhe progresi — i dukshëm vetëm për ty dhe trajnerin.",
      link: "Shëndeti & Rezultatet",
      promptTitle: "Plotëso profilin shëndetësor",
      promptDesc: "Na trego pikën e nisjes që të masësh rezultate reale.",
      promptCta: "Fillo tani",
      profileTitle: "Profili Yt",
      birthYear: "Viti i lindjes",
      height: "Gjatësia (cm)",
      startWeight: "Pesha fillestare (kg)",
      goal: "Objektivi yt",
      goalOptions: ["Të humb peshë", "Të ndërtoj muskuj", "Të korrigjoj posturën / më pak dhimbje", "Formë e përgjithshme"],
      activity: "Niveli i aktivitetit",
      activityOptions: ["Kryesisht ulur", "Pak aktiv", "Aktiv", "Shumë aktiv"],
      injuries: "Dëmtime ose operacione (opsionale)",
      medications: "Medikamente (opsionale)",
      parqTitle: "Pyetësori shëndetësor",
      parqSub: "Përgjigju sinqerisht — kjo e mban stërvitjen të sigurt.",
      parq: [
        "A të ka thënë ndonjëherë mjeku se ke problem me zemrën?",
        "A ndjen dhimbje në kraharor gjatë aktivitetit fizik?",
        "A ke pasur dhimbje në kraharor në qetësi muajin e fundit?",
        "A ndjen marrje mendsh ose humbje vetëdijeje?",
        "A ke problem me kockat a nyjet që stërvitja mund ta përkeqësojë?",
        "A merr medikamente për tensionin ose zemrën?",
        "A ka ndonjë arsye tjetër pse nuk duhet të bësh aktivitet fizik?",
      ],
      yes: "Po",
      no: "Jo",
      parqWarning:
        "Iu përgjigje 'Po' një pyetjeje — të lutem konsultohu me mjekun para stërvitjes intensive. Graciano do ta marrë parasysh.",
      consent:
        "Jap pëlqimin tim të qartë për ruajtjen e të dhënave shëndetësore (pesha, dëmtimet, përgjigjet, fotot) që trajneri të më udhëheqë stërvitjen. Mund t'i fshij në çdo kohë.",
      save: "Ruaj profilin",
      saved: "Profili u ruajt.",
      checkinTitle: "Check-in Javor",
      checkinSub: "Një herë në javë: peshohu, vlerëso javën, shto foto nëse do.",
      weight: "Pesha (kg)",
      energy: "Energjia",
      sleep: "Cilësia e gjumit",
      adherence: "Zbatimi i stërvitjes",
      soreness: "Rikuperimi (sa i freskët ndihesh?)",
      note: "Diçka për trajnerin? (opsionale)",
      photos: "Foto progresi (opsionale)",
      photoFront: "Përpara",
      photoSide: "Anash",
      photoBack: "Prapa",
      submit: "Ruaj check-in",
      submitted: "Check-in u ruajt. Shihemi javën tjetër!",
      historyTitle: "Rrugëtimi Yt",
      chartTitle: "Trendi i peshës",
      compareTitle: "Para / Tani",
      compareFirst: "Fillimi",
      compareLast: "E fundit",
      noCheckins: "Ende pa check-in — i pari nis rrugëtimin tënd.",
      delete: "Fshi",
      date: "Data",
      kg: "kg",
      alreadyThisWeek: "E ke bërë check-in këtë javë — kthehu javën tjetër.",
      error: "Diçka shkoi gabim. Provo përsëri.",
    },
    admin: {
      title: "Paneli i Adminit",
      sub: "Menaxho klientët, aksesin në programe dhe kërkesat.",
      tabClients: "Klientët",
      tabHealth: "Check-in-et",
      noHealth: "Ky klient s'e ka plotësuar ende profilin shëndetësor.",
      flag: "Shenjë mjekësore — rishiko para stërvitjes intensive",
      view: "Shiko",
      tabAccess: "Aksesi",
      tabApps: "Aplikimet",
      tabLeads: "Buletini",
      grantTitle: "Jep akses në program",
      selectClient: "Zgjidh klientin…",
      selectProgram: "Zgjidh programin…",
      grant: "Jep Akses",
      name: "Emri",
      email: "Email",
      joined: "Regjistruar",
      ...
      active: "Aktiv",
      expired: "Skaduar",
      emptyClients: "Ende pa klientë.",
      emptyAccess: "Ende pa akses të dhënë.",
      emptyApps: "Ende pa aplikime.",
      emptyLeads: "Ende pa abonentë.",
